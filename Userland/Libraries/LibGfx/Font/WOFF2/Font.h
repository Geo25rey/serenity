...
public:
    ...
    {
        dbgln("woff2 glyph metrics {} {} {}", glyph_id, x_scale, y_scale);
        return m_input_font->glyph_metrics(glyph_id, x_scale, y_scale, point_width, point_height);
    }
    ...
    {
        dbgln("woff2 rasterize {} {} {}", glyph_id, x_scale, y_scale);
