...
private:
    ...
    virtual void create_menu(i32, UTF8String const&) override;
    virtual void destroy_menu(i32) override;
    virtual void add_menu(i32, i32) override;
    virtual void add_menu_item(i32, i32, i32, UTF8String const&, bool, bool, bool, bool, UTF8String const&, Gfx::ShareableBitmap const&, bool) override;
    virtual void add_menu_separator(i32) override;
    virtual void update_menu_item(i32, i32, i32, UTF8String const&, bool, bool, bool, bool, UTF8String const&, Gfx::ShareableBitmap const&) override;
    ...
    virtual void set_wallpaper_mode(UTF8String const&) override;
